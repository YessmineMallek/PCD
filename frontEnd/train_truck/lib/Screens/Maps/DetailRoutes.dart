                ...
                SingleChildScrollView(
                  child: Container(
                    ...
                    child: ListView.builder(
                      itemCount: routeController.routeDetail.value.trip?.length ?? 0, // Null check using null-aware operator
                      itemBuilder: (context, index) {
                        var trip = routeController.routeDetail.value.trip?[index]; // Null check using null-aware operator
                        if (trip != null && trip.tripHeadsign != null) {
                          if (trip.tripHeadsign!.toLowerCase() == destination) {
                            return Container(
                              padding: EdgeInsets.symmetric(vertical: 5),
                              child: _buildTripItem(index),
                            );
                          }
                        }
                        return Container();
